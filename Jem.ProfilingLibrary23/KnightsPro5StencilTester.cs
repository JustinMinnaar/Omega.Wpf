...
//public sealed class KnightsJProfileTemplateTester
//{
//    public JProfileTemplateCompiled compiled;
//    private IWriter writer;

//    // TODO: support multiple passes where a range of min/max values is tested such that most common rotation/scale/shift is found first.

//    public KnightsJProfileTemplateTester(JProfileTemplate stencil, IWriter writer = null)
//    {
//        this.compiled = new JProfileTemplateCompiled(stencil);
//        this.writer = writer;
//    }
...
//        if (result != null && result.RatioGood >= compiled.minSuccessRatio)
//        {
//            result.Template = compiled.Template;
//        }
//        return result;
//    }
...
//    {
//        foreach (var leftIdentifier in compiled.CompiledSymbolsLeft)
//        {
//            var match = ConsiderLeftIdentifier(ocr, leftIdentifier);
//            if (match != null && match.RatioGood >= compiled.minSuccessRatio) return match;
//        }
//        return null;
//    }
...
//        CRect leftSearchRect = NewSearchRect(compiled.maxMoveDistanceX, compiled.maxMoveDistanceY, leftIdentifierPoint);
...
//            .Take(compiled.maxSymbolsToConsiderPerIdentifier).ToList();
...
//        {
//            Move = new CSize(compiled.maxMoveDistanceX, compiled.maxMoveDistanceY),
//            Origin = ocr.PageRect.CenterPoint,
//            Scaling = compiled.maximumScaling,
//            Rotation = compiled.maximumRotation,
//        };
...
//    {
//        foreach (var rightIdentifier in compiled.CompiledSymbolsRight)
//        {
...
//        CRect rightSearchRect = NewSearchRect(compiled.maxMoveDistanceX, compiled.maxMoveDistanceY, rightIdentifierPoint);
...
//            var step = writer?.AddStep(compiled.Template, $"Identifiers '{leftIdentifier.MatchCharacter}' and '{rightIdentifier.MatchCharacter}'");
...
//            if (scaling < compiled.minimumScaling || scaling > compiled.maximumScaling)
//            {
...
//            if (rotation < compiled.minimumRotation || rotation > compiled.maximumRotation)
//            {
//                shpLeftToRightLine?.SetBehaviour(EPro5Behaviour.Bad);
...
//            if (Math.Abs(theory.Move.Width) >= compiled.maxMoveDistanceX) continue;
//            if (Math.Abs(theory.Move.Height) >= compiled.maxMoveDistanceY) continue;
...
//            if (match.RatioGood >= compiled.minSuccessRatio)
//            {
...
//        var step = writer?.AddStep(compiled.Template, $"Test for {compiled.Template.MinSuccessPercentage}% of {compiled.CompiledSymbols.Count} identifier symbols.");
